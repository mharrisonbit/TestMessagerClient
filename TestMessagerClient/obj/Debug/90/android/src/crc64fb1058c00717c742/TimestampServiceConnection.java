...
public class TimestampServiceConnection
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("TestMessagerClient.TimestampServiceConnection, TestMessagerClient", TimestampServiceConnection.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == TimestampServiceConnection.class)
			mono.android.TypeManager.Activate ("TestMessagerClient.TimestampServiceConnection, TestMessagerClient", "", this, new java.lang.Object[] {  });
	}

	public TimestampServiceConnection (crc64fb1058c00717c742.MainActivity p0)
	{
		super ();
		if (getClass () == TimestampServiceConnection.class)
			mono.android.TypeManager.Activate ("TestMessagerClient.TimestampServiceConnection, TestMessagerClient", "TestMessagerClient.MainActivity, TestMessagerClient", this, new java.lang.Object[] { p0 });
	}
